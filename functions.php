...
function it_solutions_widgets_init() { 	
	...
	register_sidebar( array(
		...
		'name'          => esc_html__( 'Header Contact', 'it-solutions' ),

		'description'   => esc_html__( 'Information in header', 'it-solutions' ),
...
function it_solutions_font_url(){
		...
		*/
		...
		$scada = _x('off','Scada:on or off','it-solutions');	

		$lato = _x('off','Lato:on or off','it-solutions');	

		$roboto = _x('on','Roboto:on or off','it-solutions');

		$opensans = _x('on','Open Sans:on or off','it-solutions');

		$assistant = _x('off','Assistant:on or off','it-solutions');

		$lora = _x('off','Lora:on or off','it-solutions');

		$kaushanscript = _x('off','Kaushan Script:on or off','it-solutions');
...
function it_solutions_scripts() {
  wp_enqueue_style('honeycomb',get_template_directory_uri().'/css/honeycomb.css?v7');
	...
	wp_enqueue_script( 'it-solutions-sticky-js', get_template_directory_uri() . '/js/jquery.sticky.js' );	
